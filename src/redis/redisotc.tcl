proc tcount_redis {bm interval masterthread} {
global tc_threadID
...
proc read_more { MASTER library redis_host redis_port interval old tce bm } {
set timeout 0
set iconflag 0
...
if {[catch {set redis [redis $redis_host $redis_port]} message]} {
...
if { $timeout != 0 } { break }
if {[catch {set redisinfo [ $redis $sqc ]} message]} {
...
eval [ subst {thread::send -async $tc_threadID { read_more $masterthread $library $redis_host $redis_port $interval $old tce $bm }}]
} 
