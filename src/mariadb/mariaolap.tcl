...
proc do_tpch { host port socket ssl_options scale_fact user password db maria_tpch_storage_engine num_vu {tidesdb_opts {}} } {
    ...
    if { $threaded eq "SINGLE-THREADED" || $threaded eq "MULTI-THREADED" && $myposition eq 1 } {
        ...
        if { [ string toupper $maria_tpch_storage_engine ] eq "TIDESDB" } {
            set tidesdb_opts "compression $maria_tpch_tidesdb_compression sync_mode $maria_tpch_tidesdb_sync_mode write_buffer_size $maria_tpch_tidesdb_write_buffer_size bloom_filter $maria_tpch_tidesdb_bloom_filter use_btree $maria_tpch_tidesdb_use_btree isolation_level $maria_tpch_tidesdb_isolation_level bloom_fpr $maria_tpch_tidesdb_bloom_fpr sync_interval_us $maria_tpch_tidesdb_sync_interval_us level_size_ratio $maria_tpch_tidesdb_level_size_ratio min_levels $maria_tpch_tidesdb_min_levels skip_list_max_level $maria_tpch_tidesdb_skip_list_max_level skip_list_probability $maria_tpch_tidesdb_skip_list_probability l1_file_count_trigger $maria_tpch_tidesdb_l1_file_count_trigger ttl $maria_tpch_tidesdb_ttl encrypted $maria_tpch_tidesdb_encrypted encryption_key_id $maria_tpch_tidesdb_encryption_key_id"
