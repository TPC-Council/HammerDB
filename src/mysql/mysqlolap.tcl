...
set ntimes 1
ed_edit_clear
set _ED(packagekeyname) "MySQL HDB TPC-H creation"
...
set _ED(packagekeyname) "MySQL HDB TPC-H"
.ed_mainFrame.mainwin.textFrame.left.text fastinsert end "#!/usr/local/bin/tclsh8.6
#EDITABLE OPTIONS##################################################
