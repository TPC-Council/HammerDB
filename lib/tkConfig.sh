...
# installed.
TK_PREFIX='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tk'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tk'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Build/Tk -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tk/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tk/include'
...
# compiled.
TK_SRC_DIR='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Build/Tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Build/Tk -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tk/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Build/Tk/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tk/lib/libtkstub8.6.a'
