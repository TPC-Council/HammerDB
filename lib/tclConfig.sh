...
# installed.
TCL_PREFIX='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tcl'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tcl'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Build/Tcl -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tcl/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tcl/include'
...
# compiled.
TCL_SRC_DIR='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Build/Tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tcl/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Build/Tcl -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tcl/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Build/Tcl/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/HammerDB-master/Build/BawtBuild/Linux/x64/Release/Install/Tcl/lib/libtclstub8.6.a'
