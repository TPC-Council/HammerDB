...
namespace eval ::tooltip {
	...
	#set labelOpts [list -highlightthickness 0 -relief solid -bd 1 -background lightyellow -fg black]
	set labelOpts [list -highlightthickness 0 -relief solid -bd 1 -background white  -fg black]
    }
